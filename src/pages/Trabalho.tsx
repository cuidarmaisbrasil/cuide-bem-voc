...
import { ShieldCheck, TrendingDown, HeartPulse, ArrowRight, CheckCircle2, Lock, FlaskConical, Briefcase, FileText, Activity, Users, Building2, AlertOctagon, ShieldAlert, Layers } from "lucide-react";
              ...
              <TabsContent value="signup">
                <form onSubmit={handleAuth} className="space-y-3 mt-4">
                  ...
                  <p className="text-xs text-muted-foreground">
                    Após a aprovação, você cadastra o gestor de ciclos direto no painel da empresa.
                  </p>
